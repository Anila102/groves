...
const CuisineSection = () => {
  return (
    ...
    <div className='container d-flex justify-content-center flex-wrap px-5 py-3'>
      ...
      <div className='video-text px-5'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Simply dummy text of the printing and typesetting.
      </div>
    </div>
